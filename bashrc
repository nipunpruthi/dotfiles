...
# source /home/nipun/miniconda3/etc/profile.d/conda.sh  # commented out by conda initialize
...
##__conda_setup="$('/home/nipun/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
##if [ $? -eq 0 ]; then
##    eval "$__conda_setup"
##else
